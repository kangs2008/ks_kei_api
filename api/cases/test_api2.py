...
from api.apikeywords.apiKeyWords2 import Http
from Common.excel_api import excel_to_case, load_excel, excel_to_save, write_to_excel
...
class TestAPI():
    ...
    def test_all_api(self, requests_session, data):
        ...
        for va in list(data.values())[3]:
            ...
            #
            #     if case["check_sql"]:
            #         count = db.select_one_data(case["check_sql"])
            #         print('count', count)
